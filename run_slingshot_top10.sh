...
echo "========================================"
echo " Slingshot + Modified Banjo: Top 10"
echo "========================================"
...
mkdir -p results/reproduced/top10

echo
echo "Input: data/banjo_inputs/top10_slingshot_input.txt"
echo "Genes: 10"
...
java \
    ...
    settingsFile=configs/banjo_top10.txt

echo
echo "Top-10 analysis complete."
echo "Results are in:"
echo "  results/reproduced/top10/"
