...
//		}
	...
	public String createNewDotFile(String dotCommandsForTopGraph, ArrayList<SLUGene> arrayList) {
		...
		String[] dotSections = dotCommandsForTopGraph.split("\\n\\n");
String[] graphOutputs = new String[0];

if (dotSections.length > 3) {
String edgeBlock = dotSections[3].split("\\n}\\n")[0];

if (edgeBlock.contains("->")) {
graphOutputs = edgeBlock.split("\\n");
}
} // safe when graph has no non-identity edges
		String parent;
		String child;
		SLUGene node;
